...
export const ClientHeader = ({
  ...
  const handleConfigureClient = () => {
    if (selectedClientId && selectedClientId !== "all") {
      navigate(`/dashboard/super_admin/clientes/${selectedClientId}/edit`);
    }
  };
    ...
    <div className="flex justify-between items-end mb-10">
      ...
      {selectedClientId !== "all" && (
        <button
          ...
          className="group flex items-center gap-2 px-5 py-2.5 bg-accent/10 border border-accent/30 rounded-lg text-accent hover:bg-accent/20 transition-all hover:scale-105"
        >
          <HiPlus
            size={18}
