export function LoginBackground() {
  return (
    <div className="absolute inset-0 bg-bg-main">
      ...
      <div className="absolute w-150 h-150 rounded-full top-[-10%] left-[-5%] gradient-login-orb1 animate-login-orb1" />
      <div className="absolute w-100 h-100 rounded-full bottom-[5%] right-[10%] gradient-login-orb2 animate-login-orb2" />
